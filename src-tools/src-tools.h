...
int compare_extras(const std::filesystem::path &root, std::ostream &output, const CompareExtrasOptions &options, ComparisonOutput &out);
int compare_resources(const std::filesystem::path &root, std::ostream &output, const CompareExtrasOptions &options, ComparisonOutput &out);
